...
function LoginScreen() {
  ...
  return (
    <div>
      <section className="bg-[#F8F8F8] py-20 lg:py-[120px]">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-8">
                      <input
                        type="submit"
                        value="Sign In"
                        className="border-primary bg-primary w-full cursor-pointer rounded-md border py-3 px-[14px] text-white transition hover:bg-opacity-90"
                      />
                    </div>
                  </form>
                </div>
