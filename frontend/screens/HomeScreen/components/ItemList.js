                ...
                <thead>
                  <tr className="bg-[#F9FAFB] text-left">
                    ...
                    <th className="text-body-color min-w-[280px] py-4 px-4 text-base font-medium uppercase">
                      <SortButton
                        // asc={
                        //   orderByField == "location" ? orderAscending : "asc"
                        // }
                        onClick={(asc) => {
                          onSort && onSort("location", asc);
                        }}
                      >
                        Location
                      </SortButton>
                    </th>
                    <th className="text-body-color min-w-[50px] py-4 px-4 text-base font-medium uppercase">
                      <SortButton
                        // asc={
                        //   orderByField == "quantity" ? orderAscending : "asc"
                        // }
                        onClick={(asc) => {
                          onSort && onSort("quantity", asc);
                        }}
                      >
                        Quantity
                      </SortButton>
